class UTComp_SuperShockRifleEffect extends UTComp_WeaponEffect
	abstract;

static function Play(PlayerController Context, UTComp_Settings Settings, Pawn Source, vector SourceLocation,  vector Direction, vector HitLocation, vector HitNormal, int ReflectNum)
{
